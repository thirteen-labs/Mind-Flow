...
const WORDS = [
  ...
  'art', 'artifact', 'artist', 'artwork', 'ask', 'aspect', 'assault', 'asset', 'assist', 'assume',
  ...
  'camp', 'can', 'canal', 'cancel', 'candle', 'candy', 'cannon', 'canoe', 'canvas', 'canyon',
  ...
  'click', 'client', 'cliff', 'climb', 'clinic', 'clip', 'clock', 'clockwork', 'clone', 'close',
  ...
  'damp', 'dance', 'danger', 'daring', 'dark', 'dash', 'date', 'daughter', 'dawn', 'day',
  'deal', 'dealer', 'dear', 'death', 'debate', 'debt', 'decade', 'decide', 'decimal', 'deck',
  'declare', 'decline', 'decoy', 'decrease', 'decree', 'dedicate', 'deep', 'deer', 'defeat', 'defend',
  'define', 'defy', 'degree', 'delay', 'deliver', 'demand', 'demise', 'denial', 'dentist', 'deny',
  'depart', 'depend', 'deposit', 'depth', 'deputy', 'derive', 'describe', 'desert', 'design', 'desk',
  'despair', 'destroy', 'detail', 'detect', 'develop', 'device', 'devote', 'diagram', 'dial', 'diamond',
  'diary', 'dice', 'diesel', 'diet', 'differ', 'digital', 'dignity', 'dilemma', 'dinner', 'dinosaur',
  'direct', 'dirt', 'disagree', 'discover', 'disease', 'dish', 'dismiss', 'display', 'distance', 'divert',
  ...
  'mystery', 'myth', 'naive', 'name', 'narrative', 'narrow', 'nation', 'nature', 'near', 'neck',
  ...
  'occur', 'ocean', 'october', 'odor', 'off', 'offend', 'offer', 'office', 'often', 'oil',
  ...
  'reduce', 'reflect', 'reform', 'refuse', 'region', 'regret', 'reject', 'relax', 'release', 'relief',
  'rely', 'remain', 'remember', 'remind', 'remove', 'render', 'renew', 'rent', 'reopen', 'repair',
  'repeat', 'replace', 'report', 'require', 'rescue', 'resign', 'resist', 'resource', 'response', 'result',
  ...
  'supply', 'support', 'surge', 'surprise', 'surround', 'survey', 'suspect', 'sustain', 'swallow', 'swamp',
  ...
  'theory', 'there', 'thermostat', 'thick', 'thin', 'thing', 'think', 'third', 'this', 'thorn',
  'thorough', 'those', 'three', 'thrive', 'throw', 'thumb', 'thunder', 'ticket', 'tide', 'tiger',
  ...
  'visit', 'visual', 'vital', 'vivid', 'vocal', 'voice', 'volcano', 'volume', 'vote', 'voyage',
...
export const RecoveryPhraseService = {
  generatePhrase(wordCount: 12 | 24 = 12): string {
    return getWords(wordCount).join(' ');
  },
